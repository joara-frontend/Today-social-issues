  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([data-range-end=true])]:rounded-r-md",
          props.mode === "range"
            ? "[&:has([data-range-end=true])]:rounded-r-md [&:has([data-range-start=true])]:rounded-l-md first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md"
